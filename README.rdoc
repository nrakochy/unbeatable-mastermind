...
key_pegs.rb and eliminator.rb are not files used in the game. Rather, they are combined as reducer.rb with no explicit class in the game. The specs will give you a sense of the logic of how the answer reducer is working, though the specs are not testing the actual game. Probably something that I need to do in the future.
